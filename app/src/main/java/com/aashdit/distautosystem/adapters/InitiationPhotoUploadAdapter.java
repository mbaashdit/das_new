...
public class InitiationPhotoUploadAdapter extends RecyclerView.Adapter<InitiationPhotoUploadAdapter.ChangeLocationHolder> {
 ...
 private double longitude;
    ...
    public InitiationPhotoUploadAdapter(Context mCtx, List<InitiationUploaded> photosList) {
        this.mCtx = mCtx;
