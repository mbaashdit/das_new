...
public class InitiationProjImagesAdapter extends RecyclerView.Adapter<InitiationProjImagesAdapter.ProjectListHolder> {

    private static final String TAG = "ProjectListAdapter";

    private Context mContext;
    private InitiationUploaded p;
//    private String imageUrl, currPhaseCode, currStageCode, stageCode;
    private ArrayList<UploadedPhotoDetail> addressData;

    public InitiationProjImagesAdapter(Context mContext, InitiationUploaded projects, ArrayList<UploadedPhotoDetail> imageUrl) {
    ...
    public void onBindViewHolder(@NonNull ProjectListHolder holder, int position) {
        ...
        UploadedPhotoDetail data = addressData.get(position);
